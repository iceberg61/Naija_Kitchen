...
const timeline = [
  { year: "2018", title: "The Beginning",       desc: "Mama Titi started cooking from her Lagos home kitchen, taking orders from neighbours through WhatsApp." },
  { year: "2020", title: "First Physical Shop", desc: "After two years of rapid growth, we opened our first small shop in Lekki — 10 seats, always full." },
  { year: "2022", title: "Going Online",         desc: "We launched our delivery platform, bringing Naija Kitchen to doorsteps across Lagos and Abuja." },
  { year: "2024", title: "Naija Kitchen Today", desc: "Three locations, a catering arm, and thousands of happy customers later — we're just getting started." },
];

const team = [
  { name: "Titilayo Adeyemi",  role: "Founder & Head Chef",     img: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80", bio: "Mama Titi has been cooking traditional Yoruba dishes since she was 8. Her egusi is the stuff of legend." },
  { name: "Emeka Okonkwo",     role: "Operations Manager",       img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&q=80", bio: "Emeka keeps everything running like clockwork — from delivery logistics to staff scheduling." },
  { name: "Amina Bello",       role: "Head of Customer Experience", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&q=80", bio: "Amina makes sure every customer feels at home. She personally responds to every review." },
  { name: "Chidi Nwosu",       role: "Head of Catering",         img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&q=80", bio: "Chidi has catered over 200 events. He brings the Naija Kitchen experience to every gathering." },
];
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="relative bg-red-800 text-white py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
            More Than a Restaurant —<br />It's a Piece of Home
          </h1>
          <p className="text-red-100 text-base md:text-lg max-w-xl mx-auto">
            Naija Kitchen was born from a mother's love for feeding people well.
            Today, that same love goes into every plate we serve.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          ...
          />
          {/* Floating quote card */}
          <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-2xl shadow-lg p-4 max-w-[220px] border border-gray-100">
            <p className="text-gray-600 text-xs italic leading-relaxed">
              "I cook the way my mother taught me — with patience, pepper, and plenty of love."
            </p>
        ...
        <div className="pt-6 lg:pt-0">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mt-2 mb-5">
            From a Home Kitchen<br />to a Household Name
          </h2>
          <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
            <p>
              It all started in 2018, when <strong className="text-gray-800">Titilayo "Mama Titi" Adeyemi</strong> began
              cooking for her neighbours in Lagos. Her egusi soup, smoky jollof, and pepper soup quickly became the
              talk of the street — and orders started flooding in through WhatsApp.
            </p>
            <p>
              What started as a side passion quickly became something she couldn't ignore. By 2020, she had saved
              enough to open a small 10-seat spot in Lekki. The tables were full from day one.
            </p>
            <p>
              Today, Naija Kitchen serves thousands of customers across multiple locations and delivers across Lagos
              and Abuja. But the recipe hasn't changed — same ingredients, same care, same love in every bowl.
            </p>
          </div>
          <Link
            to="/menu"
            className="inline-flex items-center gap-2 mt-8 bg-red-700 hover:bg-red-900 text-white px-6 py-3 rounded-full text-sm font-semibold transition-colors"
          >
      ...
      <div className="bg-red-800 text-white py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            To Make Every Nigerian Feel at Home — One Plate at a Time
          </h2>
          <p className="text-red-100 text-base leading-relaxed max-w-2xl mx-auto">
            We believe food is more than fuel — it's memory, identity, and belonging. Our mission is to keep the
            flavours of Nigeria alive, accessible, and celebrated, whether you're around the corner or far from home.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-900 text-white py-16 px-4 text-center">
        ...
        <p className="text-gray-400 text-sm max-w-md mx-auto mb-8">
          Every order supports a family business built on passion and authenticity. Come eat with us.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            to="/reservation"
            className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white px-7 py-3 rounded-full text-sm font-semibold transition-colors border border-white/20"
          >
            Reserve a Table
          </Link>
        </div>
